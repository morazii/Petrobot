"""
backend/shared/data_access/mongo_client.py
--------------------------
Singleton MongoDB client for the PetroBot project.

Usage:
    from backend.shared.data_access.mongo_client import get_wells_collection
...
# Extract database name from URI â€” works for both Atlas (mongodb+srv://) and local (mongodb://)
