"""
backend/shared/data_access/seed_mongo.py
------------------------
...
Storage strategy: Full OSDU envelope stored as-is.
  ...
  - No flattening or transformation â€” data.FieldID, data.WellStatusID etc. retain their URI format
  - A uri_utils module handles URI â†” plain-value conversion at query time
  - Re-running this script is safe â€” duplicate _id errors are silently skipped

Run from the project root:
    python -m backend.shared.data_access.seed_mongo
    # or
    python backend/shared/data_access/seed_mongo.py
"""
...
ROOT = Path(__file__).resolve().parents[3]          # project root (Petrobot/)
...
from backend.shared.data_access.mongo_client import get_wells_collection   # noqa: E402


# â”€â”€ Index definitions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
INDEXES = [
    # Well identity
...
def insert_documents(collection, docs: list[dict]) -> tuple[int, int]:
    ...
    try:
        ...
        if other_errors:
            print(f"\n  âš   {len(other_errors)} unexpected write error(s):")
...
def create_indexes(collection) -> None:
    ...
    if new_indexes:
        ...
        print("  All indexes already exist â€” skipped.")
